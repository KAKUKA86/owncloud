...
public class FileOperationController {
    ...
    public Object multiUpload(HttpServletRequest request, String filePath) {
        ...
        try {
            Object data = service.multiUploadFiles(request, filePath);
            map.put("data", data);
            map.put("code", 200);
            map.put("msg", "恭喜，请求成功");
        } catch (Exception e) {
    ...
    public Object FixFileName(String filePath, String newName) {
        Map<String, Object> dataMap = new HashMap<>();
        try {
            String newPath = service.fixFileName(filePath, newName);
    ...
    public Object deleteDirs(String filePath) {
        ...
        try {
            ...
            bn = service.deleteFile(deletePath);
            if (bn) {
                dataMap.put("data", bn);
                dataMap.put("code", 200);
    ...
    public Object getAllDirs(String filePath) {
        Map<String, Object> dataMap = new HashMap<>();
        try {
            List<String> dirList = service.getAllDirection(filePath);
            dataMap.put("data", dirList);
            dataMap.put("code", 200);
            dataMap.put("root", service.getDirection());
    ...
    public Object getAllFiles(String filePath) {
        Map<String, Object> dataMap = new HashMap<>();
        try {
            List<Object> dirList = service.getAllFiles(filePath);
            dataMap.put("data", dirList);
            dataMap.put("code", 200);
            dataMap.put("msg", "恭喜，查询成功");
        } catch (Exception e) {

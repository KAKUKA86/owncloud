...
public interface NormalUserMapper {
    ...
    @Insert("insert into user_table(user_name, user_password, user_phone_number, user_register_timestamp) values (#{userName},#{userPassword},#{userPhoneNumber},#{userRegisterTimestamp})")
